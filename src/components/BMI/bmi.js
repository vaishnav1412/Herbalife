...
.catch((error) => {
  ...
  let calcBmi = (event) => {
    ...
    if (weight === 0 || height === 0) {
      ...
      const bmiValue = (convertedWeight / (convertedHeight * convertedHeight)) * 10000;
  ...
  const updatebmi =async ()=>{
    ...
    const response = await axios.post("/api/user/savebmi",formData)
  ...
  return (
    <div className="bmi_app" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", width: "100%", marginTop:"20px" ,marginBottom:"15px" }}>
    <div className="bmi_container" style={{ boxShadow: "0px 0px 12px #ccc", borderRadius: "8px", padding: "1rem" }}>
      ...
      <form onSubmit={calcBmi}>
        <div className="input-group">
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <input
              className="input_bmi"
              style={{ width: "70%", fontSize: "1.2rem", padding: "8px 4px", margin: "8px 0", borderRadius: "8px", backgroundColor: "lightslategrey" }}
              value={weight}
            ...
            <select
             ...
             onChange={(e) => setWeightUnit(e.target.value)}
              style={{ fontSize: "1.2rem", margin: "8px 0", marginLeft: "8px", borderRadius: "8px", backgroundColor: "ThreeDFace" }}
            >
      ...
      <div className="imag_container" style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <img src={imgSrc} alt="" />
      </div>
    </div>
  </div>
