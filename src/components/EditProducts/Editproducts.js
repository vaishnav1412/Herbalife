...
console.log(id);
  ...
  const getData = async () => {
    ...
    try {
      if (id) {
        const response = await axios.post("/api/admin/fetchproduct", formData);
  ...
  const handleSubmit = async (event) => {
    ...
    const  formData ={
      ...
      try {
        const response = await axios.post("/api/admin/editproducts",formData);
        if (response.data.success) {
      ...
      try {
        const response = await axios.post("/api/admin/editproductswithimage",formData,{ headers:{
